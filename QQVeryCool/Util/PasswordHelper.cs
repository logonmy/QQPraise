...
namespace QQVeryCool.Util
{
    ...
    //    {
    //        var jsFilePath = System.AppDomain.CurrentDomain.BaseDirectory + "\\util\\c_login_2.js";
    ...
    //    /// <param name="verifycode">验证码</param>
    //    /// <returns>密码密文</returns>
    //    public static string GetPassword(string password, string salt, string vcode, string isMd5)
    //    {
    //        using (var ctx = new JavascriptContext())
    //        {
    //            ctx.Run(JsFile);
    //            var result = ctx.Run(string.Format("$.Encryption.getEncryption('{0}','{1}','{2}',{3});",password,salt,vcode,isMd5)) ?? "";
